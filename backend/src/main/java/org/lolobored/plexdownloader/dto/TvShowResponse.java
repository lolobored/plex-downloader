...
public record TvShowResponse(
    ...
    boolean watched, Boolean hasEpisodesMissingSubtitles
) {
    public static TvShowResponse from(TvShow s, boolean watched, boolean hasEpisodesMissingSubtitles) {
        ...
        return new TvShowResponse(s.getId(), s.getPlexId(), s.getTitle(), s.getYear(),
            ...
            s.getGenres(), actors, watched, hasEpisodesMissingSubtitles);
    }

    public static TvShowResponse from(TvShow s, boolean watched) { return from(s, watched, false); }

    public static TvShowResponse from(TvShow s) { return from(s, false, false); }
}
